  ...
  return (
    <div className="w-60 p-2">
      <div className="p-5 shadow-lg w-48 text-lg ">
        ...
        <h1 className="font-bold border-t-4  py-4">Subscriptions</h1>
        ...
        <h1 className="font-bold border-t-4 pt-5  py-4">Watch Later</h1>
        ...
        <h1 className="font-bold border-t-4 pt-5 py-4">More from YouTube</h1>

        <div className="flex ">
          <img
            className="w-8 h-8 "
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQmqNi9H04otfOdxNYX6GtI-zM3v5HHEkBDBdp1wmQHPw&usqp=CAU&ec=48665698"
          ></img>
          <p>YT Premium</p>
        </div>
        ...
        <div className="flex ">
          <img
            className="w-8 h-8 "
            src="https://static.vecteezy.com/system/resources/thumbnails/017/396/826/small_2x/youtube-studio-icons-free-png.png"
          ></img>
          <p>YT Studio</p>
        </div>
